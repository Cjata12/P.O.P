...
int main(void) 
{
    ...
    *IX += 1; /* Z[2] se vuelve a modificar, ahora vale 12. */
    ...
    por lo tanto X toma este valor (8). Observa que IX no se reasigna */
    ...
    4 posiciones y cae en una dirección afuera del arreglo. Esto ocasionará un error. */
    Y = *IX;     /* Y se modifica, toma el valor (basura) de una celda incorrecta. 
    Es un error que no señala el compilador del lenguaje C. */
